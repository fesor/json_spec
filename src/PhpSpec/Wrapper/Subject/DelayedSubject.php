...
namespace JsonSpec\PhpSpec\Wrapper\Subject;
...
use PhpSpec\Wrapper\Subject as Subject;
 ...
 */
class DelayedSubject implements ArrayAccess, WrapperInterface
{
    /**
     * @var mixed
     */
     ...
     * @param DelayedWrapper         $wrapper
     * @param WrappedObject          $wrappedObject
     * @param Caller                 $caller
     * @param SubjectWithArrayAccess $arrayAccess
     * @param ExpectationFactory     $expectationFactory
     */
    public function __construct($subject, DelayedWrapper $wrapper, WrappedObject $wrappedObject, Caller $caller,
                                SubjectWithArrayAccess $arrayAccess, DelayedExpectationFactory $expectationFactory)
    {
